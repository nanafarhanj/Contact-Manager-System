...
Once logged in, users can add, edit, delete, and search their contacts using a clean React interface.
Contacts can be grouped into custom categories for better organization.
The backend is built with FastAPI and uses SQLModel (SQLite) for data storage, ensuring fast setup and zero‑configuration database handling.
